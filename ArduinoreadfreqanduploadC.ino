...
void setup(void) {
  ...
  // Start I2C transmission 2400
  Wire.beginTransmission(Addrc);
   // Input capacitance value, 0x01/0x00(256-512/0-255)
  Wire.write(0x01);
  // Input capacitance value, 0xFF(255)
  Wire.write(0xFF);
